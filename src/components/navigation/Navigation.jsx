...
const Navigation = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Check if click is outside nav and not on the menu button
      if (
        navRef.current && 
  ...
  // Toggle menu function with proper state handling
  const toggleMenu = () => {
      ...
      <div className="container mx-auto flex items-center justify-between py-3 px-4 sm:px-6">
        ...
        <nav className="hidden md:flex space-x-6 items-center">
          ...
          <a
            ...
            download
            className="px-3 py-1.5 border border-cyan-500 text-cyan-500 rounded-md text-sm hover:bg-cyan-500 hover:text-white transition-all duration-300 flex items-center"
          >
        ...
        >
          ...
          >
            <div className="flex flex-col space-y-6 py-8 px-6">
              <NavLink to="/about" label="01. About" active={activeLink === '/about'} />
              <NavLink to="/experience" label="02. Experience" active={activeLink === '/experience'} />
              <NavLink to="/work" label="03. Work" active={activeLink === '/work'} />
              <NavLink to="/contact" label="04. Contact" active={activeLink === '/contact'} />
              <a
                href="./Dennis_Bart-Plange_resume.pdf"
                download
                className="px-4 py-2 border border-cyan-500 text-cyan-500 rounded-md hover:bg-cyan-500 hover:text-white transition flex items-center justify-center mt-4"
              >
